...
public class Calculator {
	public static void main(String[] args) {
		...
		while(choice !=5) {
				...
				switch(choice) {
					case 1:operationObject.addition( number1, number2);
							break;
			
					case 2:operationObject.subtraction(number1, number2);
							break;
			
					case 3:operationObject.division(number1, number2);
							break;
			
					case 4:operationObject.multiplication(number1, number2);
							break;
					case 5:break;
